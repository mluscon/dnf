...
def basearch(arch):
    msg = 'The basearch function is not a part of DNF API ' \
          'and will be removed in the upcoming DNF release. ' \
          'If your project relies on this functionality, please fill ' \
          'a bugreport on DNF requesting an officially ' \
          'supported API function. ' \
